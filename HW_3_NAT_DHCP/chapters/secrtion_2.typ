= What is DHCP Option 82 ?
  ...
  DHCP Option 82 จะมาช่วยแก้ปัญหาโดยการใส่ DHCP Package ไม่ใช่ Client ใส่เอง ตัวที่ใส่ Option 82 คือ
  + DHCP Relay
  + Swtich
  + Access Device
  #figure(
  ...
  นี่คือรูปหลังจากเพิ่ม Option 82 แล้วสังเกตว่ามี data เพิ่มขึ้นช่วยให้สามารถ identify ได้ว่าส่งมาจากใครแล้วก็เพิ่ม security ได้ด้วย
